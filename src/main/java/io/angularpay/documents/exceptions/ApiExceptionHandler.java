...
import static io.angularpay.documents.common.Constants.ERROR_SOURCE;
import static io.angularpay.documents.exceptions.ErrorCode.FILE_SIZE_EXCEEDED_ERROR;
import static io.angularpay.documents.exceptions.ErrorCode.GENERIC_ERROR;
import static io.angularpay.documents.helpers.Helper.writeAsStringOrDefault;
...
public class ApiExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<Object> handleAll(Exception exception, WebRequest request) {
        ...
        HttpStatus httpStatus = Objects.nonNull(commandException) ? commandException.getStatus() :
                exception instanceof MaxUploadSizeExceededException ? HttpStatus.BAD_REQUEST :
        ...
        List<ErrorObject> errors = Objects.nonNull(validationException) && !CollectionUtils.isEmpty(validationException.getErrors()) ?
                ...
                Objects.nonNull(commandException) ?
                        Collections.singletonList(ErrorObject.builder()
                                ...
                                .build()) :
                        Collections.singletonList(ErrorObject.builder()
                                .code(exception instanceof MaxUploadSizeExceededException ? FILE_SIZE_EXCEEDED_ERROR : GENERIC_ERROR)
                                .message(exception instanceof MaxUploadSizeExceededException ? FILE_SIZE_EXCEEDED_ERROR.getDefaultMessage() : exception.getMessage())
                                .source(ERROR_SOURCE)
                                .build());
