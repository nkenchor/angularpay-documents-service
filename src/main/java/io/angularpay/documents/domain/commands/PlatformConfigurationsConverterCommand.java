...
import io.angularpay.documents.models.platform.*;
...
import static io.angularpay.documents.exceptions.ErrorCode.INVALID_MESSAGE_ERROR;
import static io.angularpay.documents.models.platform.PlatformConfigurationSource.HASH;
